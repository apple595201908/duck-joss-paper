...
- Keep the dedicated paper-supply card centered against the bottom edge during play, with visible clearance from the duck and separated from the left-side flare warning. Its pile and percentage must derive from the same remaining-paper ratio.
