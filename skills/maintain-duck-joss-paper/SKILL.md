...
- Keep the count-up timer tight to the top edge in an ample red-and-gold casing with a dark display window. Draw the large red time using complete seven-segment LED glyphs, never decorative Chinese-character seals, and keep every segment inside the frame.
